...
function wpforms_email_entries_page() {
    add_menu_page(
        'WPForms Emails',        // Page title
        'WPForms Emails',        // Menu title
        'manage_options',        // Capability
        'wpforms-email-entries', // Menu slug
        'display_wpforms_emails' // Callback function
    );
}
add_action('admin_menu', 'wpforms_email_entries_page');
